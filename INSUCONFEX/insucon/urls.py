...
urlpatterns = [
   ...
   path('cuenta-user/cuenta/modificar-cuenta/<int:pk>/', modificar_cuenta, name='modificar_cuenta'),
    path('cuenta/modificar-cuenta-2/<int:id>/', modificar_cuenta_2, name='modificar_cuenta_2'),
    ...
    path('sumar/<int:producto_id>/', sumar_carrito, name="Sum"),
